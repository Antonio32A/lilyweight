export declare type Weights = {total: number, slayer: number, skill: {overflow: number, base: number}, catacombs: {completion: {base: number, master: number}, experience: number}}
export declare type PlayerWeights = Weights & { uuid: string, username?: string, specifiedProfile?: string}

declare class LilyWeight {
    /**
